...
namespace TarodevController {
    public class PlayerController : MonoBehaviour, IPlayerController {
        ...
        public bool endlessRunRight = false;
        ...
        private void GatherInput() {
            ...
            {
                JumpDown = InputManager.Instance.JumpDown,
                JumpUp = InputManager.Instance.JumpUp,
                X = (endlessRunRight) ? 1 : InputManager.Instance.XAxis
            };
